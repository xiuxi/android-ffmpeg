...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=//build/bin --enable-gpl --enable-version3 --enable-nonfree --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-avdevice --disable-pthreads --disable-pixelutils --disable-everything --enable-encoder=libx264 --enable-encoder=aac --enable-encoder=libfdk_aac --enable-decoder=h264 --enable-decoder=aac --enable-decoder=libfdk_aac --enable-muxer=hls --enable-muxer=h264 --enable-muxer=rtsp --enable-demuxer=rtsp --enable-demuxer=sdp --enable-demuxer=hls --enable-demuxer=h264 --enable-parser=h264 --enable-parser=aac --enable-protocol=file --enable-protocol=hls --enable-libfdk-aac --enable-libx264 --arch=aarch64 --cross-prefix=aarch64-linux-android- --enable-cross-compile --target-os=linux --extra-cflags='-march=armv8-a -I//build/bin/include -I//build/bin/include/fdk_aac' --extra-ldflags='-lm -Wl,-Bsymbolic -L//build/bin/lib' --extra-ldexeflags=-pie --extra-libs=-lgcc --enable-pic --ignore-tests
prefix=//build/bin
...
AS=aarch64-linux-android-gcc
OBJCC=aarch64-linux-android-gcc
LD=aarch64-linux-android-gcc
DEPCC=aarch64-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=aarch64-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
ARFLAGS=rcD
AR_O=$@
RANLIB=aarch64-linux-android-ranlib -D
...
CFLAGS=-D__ANDROID_API__=21  -march=armv8-a -I//build/bin/include -I//build/bin/include/fdk_aac -std=c11 -fomit-frame-pointer -fPIC -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -march=armv8-a -I//build/bin/include -I//build/bin/include/fdk_aac -fPIC -g
...
DEPWINDRES=aarch64-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS= -lm -Wl,-Bsymbolic -L//build/bin/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS= -pie
LDLIBFLAGS=
...
EXTRALIBS=-lx264 -lfdk-aac -lm  -lz -lgcc 
